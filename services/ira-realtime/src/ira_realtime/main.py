"""FastAPI entry point for Ira realtime audio."""
...
app = FastAPI(title="Ira Realtime", version="0.1.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
    allow_methods=["*"],
...
async def root() -> dict[str, object]:
    ...
    if settings.mode == "ira":
        payload["ira_url"] = settings.ira_url
