...
from leo_realtime.tts import PocketTtsService, create_tts, pocket_language, reset_pocket_models
...
def test_create_tts_pocket_builds_service(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("leo_realtime.tts.load_pocket_model", load)
...
def test_load_pocket_model_is_cached(monkeypatch: pytest.MonkeyPatch) -> None:
    from leo_realtime import tts as tts_mod
